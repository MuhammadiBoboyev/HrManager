package uz.pdp.lesson_5.configuration;
...
import uz.pdp.lesson_5.security.JwtFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .httpBasic().disable()
                .authorizeRequests()
                .antMatchers("/api/auth/register", "/api/auth/verificationEmail", "/api/auth/login").permitAll()
                .anyRequest()
                .authenticated();
        http
